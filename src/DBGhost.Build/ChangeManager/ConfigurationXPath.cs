...
namespace DbGhost.Build.ChangeManager
{
	public static class ConfigurationXPath
	{
		...
		public const string ChangeSchemaScriptsPath = "/DBGhost/ChangeManager/SchemaScripts/*/Path";
		public const string ChangeSchemaScriptsDropCreateDbase = "/DBGhost/ChangeManager/SchemaScripts/DropCreateDatabaseScript";
		...
		public const string ChangeCompareOptionsKeepNewDb = "/DBGhost/ChangeManager/CompareOptions/KeepNewDatabase";
	}
}
